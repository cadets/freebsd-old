...
struct sysent sysent[] = {
	...
	{ AS(aio_read_args), (sy_call_t *)sys_aio_read, AUE_READ, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 255 = aio_read */
	{ AS(aio_write_args), (sy_call_t *)sys_aio_write, AUE_WRITE, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 256 = aio_write */
