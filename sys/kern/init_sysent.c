...
struct sysent sysent[] = {
	...
	{ AS(metaio_read_args), (sy_call_t *)sys_metaio_read, AUE_READ, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 571 = metaio_read */
	{ AS(metaio_write_args), (sy_call_t *)sys_metaio_write, AUE_WRITE, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 572 = metaio_write */
	{ AS(metaio_mmap_args), (sy_call_t *)sys_metaio_mmap, AUE_MMAP, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 573 = metaio_mmap */
	...
	{ AS(metaio_readv_args), (sy_call_t *)sys_metaio_readv, AUE_READV, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 577 = metaio_readv */
	{ AS(metaio_writev_args), (sy_call_t *)sys_metaio_writev, AUE_WRITEV, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 578 = metaio_writev */
	{ AS(metaio_pread_args), (sy_call_t *)sys_metaio_pread, AUE_PREAD, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 579 = metaio_pread */
	{ AS(metaio_pwrite_args), (sy_call_t *)sys_metaio_pwrite, AUE_PWRITE, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 580 = metaio_pwrite */
	{ AS(metaio_preadv_args), (sy_call_t *)sys_metaio_preadv, AUE_PREADV, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 581 = metaio_preadv */
	{ AS(metaio_pwritev_args), (sy_call_t *)sys_metaio_pwritev, AUE_PWRITEV, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 582 = metaio_pwritev */
	{ AS(metaio_sendto_args), (sy_call_t *)sys_metaio_sendto, AUE_SENDTO, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 583 = metaio_sendto */
	{ AS(metaio_recvfrom_args), (sy_call_t *)sys_metaio_recvfrom, AUE_RECVFROM, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 584 = metaio_recvfrom */
