...
fbt_excluded(const char *name)
{
	 ...
	 * by 'X_db_*' functions.
	 *
	 * We also exclude all kobj_lookup_method* functions as they are called
	 * by the autogenerated code in LINKER_* functions.
	 */
	if (strncmp(name, "db_", 3) == 0 ||
	    ...
	    strncmp(name, "kobj_lookup_method",
	    sizeof("kobj_lookup_method") - 1) == 0)
		return (1);
