    ...
    dtrace_mstate_t *mstate)
{
	 ...
	 * BYREF return value.
	 */
	strsz = dtrace_strlen(mstate, (char *)addr, size) + 1;
	...
	dtrace_strcpy(mstate, (const void *)addr, (void *)mstate->dtms_scratch_ptr,
	    strsz);
    ...
    dtrace_mstate_t *mstate)
{
	...
	dtrace_bcopy(mstate, (const void *)addr, (void *)mstate->dtms_scratch_ptr,
	    strsz);
